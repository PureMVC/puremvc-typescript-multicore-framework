...
describe("ViewTest", () => {
  ...
  test("testGetInstance", () => {
    // Test Factory Method
    const view: IView = View.getInstance(
      "ViewTestKey1",
  ...
  test("testRegisterAndRetrieveMediator", () => {
    ...
    const mediator: IMediator | null = view.retrieveMediator(
      ViewTestMediator.NAME,
    );
  ...
  test("testSuccessiveRegisterAndRemoveMediator", () => {
    ...
    expect(view.retrieveMediator(ViewTestMediator.NAME)).toBeInstanceOf(
      ViewTestMediator,
    );
  ...
  test("testModifyObserverListDuringNotification", () => {
    ...
    view.registerMediator(
      new ViewTestMediator6(ViewTestMediator6.NAME + "/1", obj),
    );
    view.registerMediator(
      new ViewTestMediator6(ViewTestMediator6.NAME + "/2", obj),
    );
    view.registerMediator(
      new ViewTestMediator6(ViewTestMediator6.NAME + "/3", obj),
    );
    view.registerMediator(
      new ViewTestMediator6(ViewTestMediator6.NAME + "/4", obj),
    );
    view.registerMediator(
      new ViewTestMediator6(ViewTestMediator6.NAME + "/5", obj),
    );
    view.registerMediator(
      new ViewTestMediator6(ViewTestMediator6.NAME + "/6", obj),
    );
    view.registerMediator(
      new ViewTestMediator6(ViewTestMediator6.NAME + "/7", obj),
    );
    view.registerMediator(
      new ViewTestMediator6(ViewTestMediator6.NAME + "/8", obj),
    );
